...
use lsm_wrapper::compact::{
    CompactionOptions, LeveledCompactionOptions, SimpleLeveledCompactionOptions,
    TieredCompactionOptions,
};
use lsm_wrapper::iterators::StorageIterator;
use lsm_wrapper::lsm_storage::{Lsm, LsmStorageOptions};
...
impl ReplBuilder {
    pub fn new() -> Self {
        Self {
            app_name: "lsm-cli".to_string(),
            description: "A CLI for lsm".to_string(),
            prompt: "lsm-cli> ".to_string(),
        }
    }
